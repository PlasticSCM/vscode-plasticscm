...
export const EmptyChanges: IPendingChanges = {
...
export async function run(rootDir: string, shell: ICmShell): Promise<IPendingChanges> {
  ...
  return result.result ?? EmptyChanges;
}
